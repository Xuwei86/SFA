...
class custom_att(nn.Module):
    def __init__(self, channel1, channel2,  ks=7, groups=16, gamma=1.4, b=1.4):
        ...
        kernel_size = int(abs((math.log(channel1, 2) + b) / gamma)) + 2
...
class MBV2_SA_ELA2(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.):
        super(MBV2_SA_ELA2, self).__init__()
...
def mbv2_sa_ela2(**kwargs):
    return MBV2_SA_ELA2(**kwargs)
